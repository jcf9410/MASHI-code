...
//    }  //so you can see the captured string 
  ...
  {                                                                                 // enter timed loop
      ...
      PWM_val_L= updatePid_L(PWM_val_L, speed_req_L, speed_act_L);         // compute PWM value Left
      PWM_val_R= updatePid_R(PWM_val_R, speed_req_R, speed_act_R);         // compute PWM value Right
...
//
      ...
      servoL.writeMicroseconds(constrain((int)PWM_val_L,800,2200));
      servoR.writeMicroseconds(constrain((int)PWM_val_R,800,2200));
  }
